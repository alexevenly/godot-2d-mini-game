...
func trigger_game_over() -> void:
	...
	main.game_state.set_state(GAME_STATE.GameStateType.LOST)
...
func trigger_level_win() -> void:
	...
	main.game_state.set_state(GAME_STATE.GameStateType.WON)
...
func handle_restart_pressed() -> void:
	...
	if main.prevent_game_over and main.game_state.current_state == GAME_STATE.GameStateType.WON:
	...
	elif main.game_state.current_state == GAME_STATE.GameStateType.WON:
	...
	elif main.game_state.current_state == GAME_STATE.GameStateType.LOST:
		main.prevent_game_over = false
...
func _get_state_label(state: int) -> String:
	match state:
		GAME_STATE.GameStateType.PLAYING:
			return "PLAYING"
		GAME_STATE.GameStateType.WON:
			return "WON"
		GAME_STATE.GameStateType.LOST:
			return "LOST"
	return str(state)
